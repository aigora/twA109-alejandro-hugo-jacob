...
void intervalo(int valor){
  ...
  switch(valor){
    ...
    case 1:{
      ...
      servo.write(18);                  // lo mueve a esa pos
    ...
    case 2:{
      ...
      servo.write(36);                  // lo mueve a esa pos
    ...
    case 3:{
      ...
      servo.write(54);                  // lo mueve a esa pos
    ...
    case 4:{
      ...
      servo.write(72);                  // lo mueve a esa pos
    ...
    case 5:{
      ...
      servo.write(90);                  // lo mueve a esa pos
    ...
    case 6:{
      ...
      servo.write(108);                  // lo mueve a esa pos
    ...
    case 7:{
      ...
      servo.write(126);                  // lo mueve a esa pos
    ...
    case 8:{
      ...
      servo.write(144);                  // lo mueve a esa pos
    ...
    case 9:{
      ...
      servo.write(162);                  // lo mueve a esa pos
    ...
    case 10:{
      ...
      servo.write(180);                  // lo mueve a esa pos
